/**
 * stonedog-howto/styled — the `stonedog-style` presentation layer.
 *
 ...
 *   - add BOTH `./node_modules/stonedog-howto/src/**` and
 *     `../../node_modules/stonedog-howto/src/**` to `include`, plus the same
